...
import com.azavea.hiveless.serializers.{HSerializer, ProductDeserializer}
import org.apache.hadoop.hive.ql.udf.generic.GenericUDF
import org.apache.spark.sql.types.DataType

import scala.util.Try

abstract class HUDF[P, R](implicit d: ProductDeserializer[Try, P], s: HSerializer[R]) extends HGenericUDF[R] {
